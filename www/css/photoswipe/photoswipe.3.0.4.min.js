...
{type:h.EventTypes.onBeforeHide,target:this});this.uiLayer.dispose();this.uiLayer=null;if(!a.isNothing(this.toolbar))this.toolbar.dispose(),this.toolbar=null;this.carousel.dispose();this.carousel=null;a.DOM.removeClass(e.document.body,h.CssClasses.activeBody);this.documentOverlay.dispose();this.documentOverlay=null;this._isResettingPosition=!1;h.unsetActivateInstance(this);
a.Events.fire(this,{type:h.EventTypes.onHide,target:this});this.goBackInHistory();

    // ***********************************************************************
    // ADDED BY BREF ON HIDE
    if (typeof jQuery != 'undefined') {
    jQuery(document.body).trigger ("photoswipe.onhide");
    }
    // ***********************************************************************

}}},goBackInHistory:function(){this.isBackEventSupported&&
